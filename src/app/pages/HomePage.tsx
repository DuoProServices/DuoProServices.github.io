  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        {/* 🧪 DEBUG BUTTON - Test Server Connection */}
        <button
          onClick={() => navigate('/test-server-connection')}
          className="fixed bottom-4 right-4 z-50 bg-purple-600 hover:bg-purple-700 text-white px-4 py-3 rounded-full shadow-lg flex items-center gap-2 text-sm font-semibold transition-all hover:scale-105"
