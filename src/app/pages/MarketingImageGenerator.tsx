...
const templates: Template[] = [
  ...
  { id: "facebook-post", name: "Facebook Post", width: 1200, height: 630, icon: Share2 },
];

const stockImages: StockImage[] = [
  { id: "calculator", name: "Calculator", url: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800" },
  { id: "money", name: "Money", url: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=800" },
  { id: "office", name: "Office", url: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800" },
  { id: "handshake", name: "Handshake", url: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800" },
  { id: "laptop", name: "Laptop", url: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=800" },
  { id: "team", name: "Team", url: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800" },
];

const colorThemes: ColorTheme[] = [
  { id: "blue", name: "Professional Blue", bg: "#1e40af", text: "#ffffff", accent: "#60a5fa" },
  { id: "green", name: "Trust Green", bg: "#065f46", text: "#ffffff", accent: "#34d399" },
  { id: "purple", name: "Modern Purple", bg: "#5b21b6", text: "#ffffff", accent: "#a78bfa" },
  { id: "dark", name: "Elegant Dark", bg: "#111827", text: "#ffffff", accent: "#f59e0b" },
  { id: "red", name: "Bold Red", bg: "#991b1b", text: "#ffffff", accent: "#fca5a5" },
];
