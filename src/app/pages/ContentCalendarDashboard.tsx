      ...
      {showNewPostForm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-semibold">Novo Post</h2>
                <p className="text-sm text-gray-500 mt-1">
                  Crie um novo post para o calendário de conteúdo
                </p>
              </div>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewPostForm({ ...newPostForm, format: e.target.value as ContentPost["format"] })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                >
                  <option value="Estático">Estático</option>
                  <option value="Reels">Reels</option>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={newPostForm.owner}
                  onChange={(e) => setNewPostForm({ ...newPostForm, owner: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  placeholder="Nome do responsável"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewPostForm({ ...newPostForm, status: e.target.value as ContentPost["status"] })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                >
                  <option value="Em análise">Em análise</option>
                  <option value="Em execução">Em execução</option>
              ...
              <div>
                ...
                <input
                  type="date"
                  value={newPostForm.publishDate}
                  onChange={(e) => setNewPostForm({ ...newPostForm, publishDate: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  value={newPostForm.observations}
                  onChange={(e) => setNewPostForm({ ...newPostForm, observations: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  rows={4}
                  placeholder="Notas e observações sobre este post..."
                />
                ...
                <button
                  onClick={() => {
                    ...
                    const newPost: ContentPost = {
                      id: posts.length + 1,
                      date: newPostForm.publishDate || "dd/mm/yyyy",
                      format: newPostForm.format,
                      theme: newPostForm.title,
                      owner: newPostForm.owner,
                      status: newPostForm.status,
                      publishDate: newPostForm.publishDate,
                      file: "",
                      observations: newPostForm.observations,
                      slides: [],
                      caption: { en: "", fr: "" },
                      hashtags: [],
                      cta: ""
