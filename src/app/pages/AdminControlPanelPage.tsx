...
import { DiagnosticPanel } from '@/app/components/admin-hub/DiagnosticPanel';

// Import admin modules
import ClientsModule from '@/app/components/admin-hub/ClientsModule';
import FinancialModule from '@/app/components/admin-hub/FinancialModule';
import ProjectsModule from '@/app/components/admin-hub/ProjectsModuleNew';
import SocialCalendarModule from '@/app/components/admin-hub/SocialCalendarModule';
